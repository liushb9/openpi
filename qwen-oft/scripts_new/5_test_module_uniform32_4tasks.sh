...
echo "========================================"
echo "5_test_module_uniform32_4tasks - 剪枝超参数分布式评测"
echo "========================================"

DEBUG=${DEBUG:-0}
DEBUG_PORT=${DEBUG_PORT:-5678}

# 与 5_train_module_uniform32_4tasks.sh 的 experiment_name 对应
...
EXP="qwen_oft_pruning-module_4tasks_uniform32"
...
echo "=========================================="
echo "5_test_module_uniform32_4tasks: All tests completed!"
echo "========================================"
