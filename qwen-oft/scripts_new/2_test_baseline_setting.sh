#!/bin/bash
# Baseline 实验对应测试脚本（最基础版本，无 DINOv3）- 分布式多 GPU 评测
# 与 2_train_baseline_setting.sh 的 5 组配置一一对应
# 用法: 可单独运行，或由 2_train_baseline_setting.sh 在全部训练完成后自动调用
# 调试: DEBUG=1 [DEBUG_PORT=5678] bash 2_test_baseline_setting.sh
# GPU 数: NUM_GPUS=4 bash 2_test_baseline_setting.sh
...
echo "========================================"
echo "Baseline Setting 测试 - 分布式评测"
echo "========================================"
...
run_names=(
  ...
  "baseline_bs4_lr1e5_minlr0_res336_aug1"
