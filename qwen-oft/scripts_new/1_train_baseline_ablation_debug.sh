...
project_path=/mnt/cpfs/wuzhuangzhe/qwen-oft
...
ckpt_path=/mnt/cpfs/luoyulin/qwen-oft/pretrained/qwen3-vl-4b-instruct
# data_path=/mnt/cpfs/chenhao/libero/libero_spatial_no_noops_image/libero_spatial_latent_8_interval_1_warmup_1.json
data_path=/mnt/cpfs/luoyulin/qwen-oft/data/4tasks_train_512.json
output_dir=/mnt/cpfs/wuzhuangzhe/qwen-oft/exp

# export WANDB_API_KEY=7230d954e9c93ad586867d7913d5fd57098bf4b7 # luoyulin
export WANDB_API_KEY=54fd5803363ff3ee55a420f3140939639ce27d38 # wuzhuangzhe

# ===========================================
# Common Settings
# ===========================================
experiment_name="qwen_oft_debug"
gpu=1
bs=4
ep=300
lr=1e-5
...
DINOV3_PATH=/mnt/cpfs/luoyulin/qwen-oft/pretrained/dino_v3_vith16
