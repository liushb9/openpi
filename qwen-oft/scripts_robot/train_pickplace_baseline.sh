...
CKPT_PATHS=("/mnt/nas/luoyulin/qwen-oft/pretrained/Qwen3-VL-4B-Instruct" "/mnt/nas/luoyulin/qwen-oft/pretrained/qwen_oft_4B_pretrain_rtx_lr_1e-5_min_lr_ratio_0.1_chunk_8_image_aug/checkpoint-0-1106069/tfmr")
...
# Common Settings
# ===========================================
experiment_name="qwen_oft_pickplace"
